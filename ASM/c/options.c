...
char tooltips1[OPTIONS_SIZE_ALL][30] = {
	...
	"Inverses the analog y-axis",
	"The camera no longer moves",
	"The equipped mask remains",
	"Replaces the transition",
	"Unequip items from the C",
	"Unequip equipment by",
	"Equip items on the B",
	"Change between previously",
	"The Crouch Stab move no",
	"Sword slashes now deal one",
	"Obtain Spiritual Stones",
	"If enabled, Rupees and",
	"Enable to set the fog",
...
char tooltips2[OPTIONS_SIZE_ALL][30] = {
	...
	"1. Enabled",
	"1. Left",
	"layouts to have the HUD",
	"layouts for the HUD",
	"controls when aiming in",
	"back behind Link when",
	"equipped after changing to",
	...
	"then health are drained",
	"distance, higher values",
	"subscreen and adjust all",
	"levitate",
	"your current maximum limit",
	"your current maximum limit",
	"your current maximum limit",
	"your current maximum limit"
};
