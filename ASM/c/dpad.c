...
void run_default_options_setup() {
    ...
    DPAD_ADULT_SET1_RIGHT = DPAD_ADULT_SET2_RIGHT = Z64_SLOT_HOVER_BOOTS;
    DPAD_ADULT_SET1_LEFT  = DPAD_ADULT_SET2_LEFT  = Z64_SLOT_IRON_BOOTS;
    DPAD_CHILD_SET1_RIGHT = DPAD_CHILD_SET2_RIGHT = Z64_SLOT_CHILD_TRADE;
    DPAD_CHILD_SET1_LEFT  =DPAD_CHILD_SET2_LEFT   =  Z64_SLOT_NUT;
    DPAD_ADULT_SET1_UP    = DPAD_ADULT_SET2_UP    = DPAD_CHILD_SET1_UP    = DPAD_CHILD_SET2_UP    = Z64_SLOT_LENS;
    DPAD_ADULT_SET1_DOWN  = DPAD_ADULT_SET2_DOWN  = DPAD_CHILD_SET1_DOWN  = DPAD_CHILD_SET2_DOWN  = Z64_SLOT_OCARINA;
}
